...
THRESHOLD = [1] #[0.1,0.5, 1, 1.5]
LEAK_COEFFICIENT = [0.01]

# Filtering Decay Rate
RESPONSE = [0.001, 0.01,0.1, ]
#### USE ONLY FOR A/B WITH PARAMETER SWEEPS OR MULTIPLE PARAMETER SWEEPS #####

factors = [MARKETING_STEADY,SOURCE_POOL, THRESHOLD, LEAK_COEFFICIENT, RESPONSE]
product = list(itertools.product(*factors))
MARKETING_STEADY,SOURCE_POOL, THRESHOLD, LEAK_COEFFICIENT, RESPONSE = zip(*product)
